        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <select class="form-control" type="text" id="tp" name="tp">
                ...
                <div class="form-group">
                    <select class="form-control" type="text" id="iduka" name="iduka">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" class="btn btn-primary" onclick="printApplicationLetter()">Cetak</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
