...
<head>
    ...
    <style rel="stylesheet">
        @page {
            ...
            background: url("https://media.discordapp.net/attachments/1178712419833491567/1178712709190131864/pkl-01.png?ex=657724c1&is=6564afc1&hm=aab22d6e1fe28cdef8112f226b7a8388d4d6c0b5d3b01192045abcad78251f52&=&format=webp&width=1021&height=665") no-repeat;
            width: 1250px;
            height: 814px;
            size: auto;
        }
